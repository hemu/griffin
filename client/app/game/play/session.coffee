...
# world variable
mWorld = require './world'
mConfig = require './game-config'
mCam = require './game-camera'
...
class SessionHost
  ...
  initialize: (player_configs) ->
    ...
    num_players = 0
    # XXX: Work around for now until I can down why spawn points aren't
    #      being correctly generated by loadFromImage call
    #                     - hemu 12/29
    # fakeSpawnPoints = [[100, 100], [140, 100], [180, 100], [220, 100]]
    # ----------------------------
